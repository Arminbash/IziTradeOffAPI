...
namespace IziTradeOff.ServicesAPI.RabbitMQ
{
    public class RabbitEventBus : IRabbitEventBus
    {
        ...
        public RabbitEventBus(IMediator mediator, IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Configuration.IConfiguration configuration)
        {
            _mediator=mediator;
